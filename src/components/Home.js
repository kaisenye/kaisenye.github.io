    ...
    >
      <div className={`transform transition-all duration-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'}`}>
        ...
        <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8">
          <a href="https://hippsc-2023.s3.us-west-1.amazonaws.com/assets/kaisenye/Kaisen+Ye+Resume.pdf" target="_blank" rel="noopener noreferrer" className="group relative">
          ...
          <a href="https://github.com/kaisenye" target="_blank" rel="noopener noreferrer" className="group relative">
            <span className="text-gray hover:text-accent transition-colors duration-300 relative text-sm pb-1">
              github.
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-accent group-hover:w-full transition-all duration-300 ease-out"></span>
            </span>
          </a>
          <a href="https://linkedin.com/in/kaisenye" target="_blank" rel="noopener noreferrer" className="group relative">
            <span className="text-gray hover:text-accent transition-colors duration-300 relative text-sm pb-1">
              linkedin.
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-accent group-hover:w-full transition-all duration-300 ease-out"></span>
            </span>
