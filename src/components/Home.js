      ...
      <div className={`transform transition-all duration-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'}`}>
        ...
        <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6">
          ...
          <a href="mailto:kaisenye20@gmail.com">
            <button className="w-full md:w-auto px-6 py-2 border-2 border-secondary text-secondary text-sm rounded-md hover:bg-lightgray transition-colors duration-300">
              Contact Me
            </button>
          </a>
        </div>
