...
const Experience = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      description:
        "Real-time security camera AI for residential complexes; deployed with 2 DTLA apartments.",
      bgColor: "bg-fluo",
      positionColor: "text-white",
      link: "",
    ...
    },
    {
      ...
      description:
        "Built web apps, workflow automations, shopify tools, and sold $50k tools",
      bgColor: "bg-hippsc",
      positionColor: "text-white",
          ...
          <div key={index} className="relative mb-16 pl-8 lg:pl-16">
            ...
            <div className={`py-6 px-8 rounded-3xl ${exp.bgColor} max-w-2xl`}>
              <div className="flex flex-col items-left mb-2">
                ...
                <div>
                  <p
                    className={`text-white text-base font-600 ${exp.positionColor} opacity-60`}
                  >
                    {exp.title}
                  </p>
