...
const Projects = () => {
  ...
  const projects = [
    {
      ...
      description:
        "A web platform that automates 12,000+ tool queries for bioprinting, visualizing 3D models and streamlining product variant access for researchers.",
      image: tryfluo,
    ...
    },
    {
      ...
      description:
        "A real-time AI surveillance system that uses computer vision to detect break-ins and security threats, processing over 20TB of footage and cutting security workflow time by 90%.",
      image: wyb,
    ...
    },
    {
      ...
      description:
        "A responsive personal portfolio website built with React and Tailwind CSS, showcasing projects, experience, and skills with smooth animations and modern design.",
      image: puffybooth,
    ...
    },
    {
      ...
      description:
        "An analytics dashboard that processes millions of e-commerce records, predicting consumer shopping behavior with 98%+ accuracy using machine learning models.",
      image: project2Cover,
  ...
  return (
    <div className="min-h-screen py-8 px-4 sm:px-8 mt-14 bg-gradient-to-b from-white to-gray-50">
      ...
      <div
        className={`grid grid-cols-1 gap-8 w-full max-w-4xl mx-auto transition-all duration-[500ms] ${
